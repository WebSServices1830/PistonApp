...
import co.edu.javeriana.sebastianmesa.conexmongo.PilotoPck.AdapterPiloto;
import co.edu.javeriana.sebastianmesa.conexmongo.PilotoPck.IndexPilotoView;
import co.edu.javeriana.sebastianmesa.conexmongo.R;

public class IndexUsuarioView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_index_usuario_view);
        ...
        adapter = new AdapterUsuario(this, cartaMenuList);

        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(this, 1);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new IndexUsuarioView.GridSpacingItemDecoration(2, dpToPx(10), true));
...
//    }
    ...
    private void prepareAlbums() {
        ...
        CartaMenu a = new CartaMenu("Crear Usuario", "Crea un nuevo usuario", covers[0]);
        cartaMenuList.add(a);

        a = new CartaMenu("Ver Usuario", "Mira los datos de un usuario", covers[1]);
        cartaMenuList.add(a);

        a = new CartaMenu("Actualizar Usuario", "Actualiza la información de un usuario", covers[2]);
        cartaMenuList.add(a);

        a = new CartaMenu("Eliminar Usuario", "Elimina un usuario del sistema", covers[3]);
        cartaMenuList.add(a);

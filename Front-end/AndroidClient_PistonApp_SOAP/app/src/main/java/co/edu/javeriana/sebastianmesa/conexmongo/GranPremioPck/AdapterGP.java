 ...
 */
public class AdapterGP extends RecyclerView.Adapter<AdapterGP.MyViewHolder> {
    ...
    public AdapterGP(Context mContext, List<CartaMenu> cartaMenuList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.thumbnail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position == 0){
                    Intent intent = new Intent(mContext, CrearGPView.class);
                    mContext.startActivity(intent);
                }
                if (position == 1){
                    Intent intent = new Intent(mContext, VerGPView.class);
                    mContext.startActivity(intent);
                }
                if (position == 2){
                    Intent intent = new Intent(mContext, ActualizarGPView.class);
                    mContext.startActivity(intent);
                }
                if (position == 3){
                    Intent intent = new Intent(mContext, EliminarGPView.class);
                    mContext.startActivity(intent);
                }
